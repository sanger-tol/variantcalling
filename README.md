...
- Run DeepVariant using filtered BAM/CRAM files against each of split fasta file.
- Merge all VCF and GVCG files generated by DeepVariant together for each input BAM/CRAM file.
...
- [Matthieu Muffato](https://github.com/muffato) for for the pipeline design, code review and Nextflow technical supports.
